...
```{r echo=FALSE}
extractedSJ_dir_in <- "/SplicingVariantsAML-main/Results/BeatAML/SpliceJunction/ExtractedSJ-Annotated/"
normalizedEx_dir_out <- "/SplicingVariantsAML-main/Results/BeatAML/SpliceJunction/NormalizedExpression/"
```
...
```{r echo=FALSE}
found_variants <- read_excel("/SplicingVariantsAML-main/Results/BeatAML/BeatAML.Variant_summary.xlsx", sheet = "Sheet 1")
...
writexl::write_xlsx(summary_res,paste0(normalizedEx_dir_out,"BeatAML.report.xlsx")
```
