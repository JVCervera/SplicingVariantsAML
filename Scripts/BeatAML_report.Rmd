...
normalization_df <- GeneSJ[,c("sample_id","case_id", "GROUP",
                              "Normalized_CanonEx19_20", "Normalized_CanonEx20_21" , "Normalized_CanonEx18_19","Normalized_SE20", "INCLUSION_Ex20","PSI_SE20",
                              "Normalized_SE19", "INCLUSION_Ex19","PSI_SE19",
                              "Normalized_SE1920", 
                              "chr13_28018590_28023349", "chr13_28015702_28018466", "chr13_28015702_28023349", 
                              "chr13_28023478_28024860",
...
colnames(normalization_df)[grep("chr13_28023478_28024860", names(normalization_df))] <- "chr13_28023478_28024860_CanonEx18-19"
...
### Canonical SJ Exon 18-19	chr13:28023478-28024860 {.tabset}
#### Expression Difference 
Normality Test:
```{r}
shapiro.test(SJCounts$Normalized_CanonEx18_19[SJCounts$GROUP == "WT"])
```

Value of Mean Normalized Expression of the Alternative SJ in WT samples:
```{r}
mean_WT_SJi <- mean(SJCounts$Normalized_CanonEx18_19[SJCounts$GROUP == "WT"], na.rm=TRUE)
mean_WT_SJi
```

Normalized Expression Value of the Alternative SJ in the MUT sample:
```{r}
MUT_SJi <- SJCounts$Normalized_CanonEx18_19[SJCounts$GROUP == "MUT"]
MUT_SJi
```

Deviation from the mean normalized expression:
```{r}
SJCounts$Difference <-  SJCounts$Normalized_CanonEx18_19 - mean_WT_SJi
```

```{r echo=FALSE}
table <- SJCounts[SJCounts$GROUP == "WT", c("sample_id", "Normalized_CanonEx18_19", "Difference")]
table <- table[order(table$Difference, decreasing = TRUE),]
```
...
```{r}
MUT_df <- SJCounts[SJCounts$GROUP == "MUT",c("sample_id","case_id", "Normalized_CanonEx18_19")]
colnames(MUT_df) <- c("sample_id", "case_id", "NormalizedExpression")
...
* **Acceptor Loss**: chr11:32396408-32399947; acceptor splice site chr11:32396408.
...
### Canonical SJ
Exon 7-6: chr11:32396408-32399947; acceptor splice site: chr11:32396408
...
Canonical splice junction: Exon 6-7: chr11:32396408-32399947; acceptor splice site: chr11:32396408
```{r echo=FALSE}
ggplotly(ggplot(plot_df, aes(sample_id,Normalized_CanonEx6_7, color=GROUP)) + 
  geom_point(aes(text=paste0("VAF RNA: ",VAF_RNA,"\nVAF MuTect: ",MuTect2_vaf,
                             "\nVAF VarScan2: ",VarScan2_vaf,
...
### Canonical SJ Exon 8-7: chr11:32392756-32396256 {.tabset}
...
MUT_df$Prediction <- "Canonical Loss"
MUT_df$splice_junction_status <- "CanonicalSJ"
MUT_df$splice_junction_position <- "chr11:32392756-32396256"
...
GeneSJ$Normalized_CanonUE <- (GeneSJ$chr11_32392756_32396256)/GeneSJ$rowSum_SJtotal*100
GeneSJ$Normalized_ES <- (GeneSJ$chr11_32392065_32396256)/GeneSJ$rowSum_SJtotal*100
```

Download the normalized values for the assessed splice junctions of all the AML samples:
```{r echo=FALSE}
normalization_df <- GeneSJ[,c("sample_id","case_id", "GROUP","Normalized_CanonDE", "Normalized_CanonUE", "Normalized_ES", "chr11_32392065_32392665",  "chr11_32392756_32396256","chr11_32392065_32396256", "rowSum_SJtotal","file_id.BAM","file_name.BAM","file_id.STAR.SJCounts","file_name.STAR.SJCounts" )]

colnames(normalization_df)[grep("chr11_32392065_32392665", names(normalization_df))] <- "chr11_32392065_32392665_CanonDE"
colnames(normalization_df)[grep("chr11_32392756_32396256", names(normalization_df))] <- "chr11_32392065_32392665_CanonDE"
colnames(normalization_df)[grep("chr11_32392065_32396256", names(normalization_df))] <- "chr11_32392065_2396256_ES"
...
### Canonical SJ Upstream Exon (UE) chr11:32392756-32396256 {.tabset}
...
* **Acceptor Loss**: chr17:7675237-7675993; acceptor splice site chr17:7675237.
* **Acceptor Gain**: chr17:7675216-7675993, found in the mutated samples.
* **Acceptor Gain**: chr17:7675234:7676033, found in the splice junction collection, not found in the mutated samples. 
...
Canonical UE: chr17:7675237-7675993; acceptor splice site chr17:7675237
...
### Static Dot Plots 
Canonical splice junction chr17:7675237-7675993, acceptor splice site chr17:7675237
```{r echo=FALSE}
...
ggplot(GeneSJ, aes(sample_id,Normalized_AG,color=GROUP)) +
  geom_point(size=.8) +
  ggtitle("Normalized expression of TP53 Acceptor Gain") +
  labs(color='GROUP') 
```
...
colnames(normalization_df)[grep("chr17_7674972_767505", names(normalization_df))] <- "chr17_7674972_7675052_CanonUE"
...
### Canonical SJ Exon downstream (DE): chr17:7674291-7674858 {.tabset}
...
```{r}
shapiro.test(SJCounts$Normalized_CanonDE[SJCounts$GROUP== "MUT"])
```

Mann-Whitney:
```{r}
wt <- wilcox.test(x=SJCounts$Normalized_CanonDE[SJCounts$GROUP== "MUT"], 
                  y=SJCounts$Normalized_CanonDE[SJCounts$GROUP== "WT"],
                  alternative = "two.sided", 
                  paired = FALSE, 
                  conf.int = 0.95)
...
stat_df$splice_junction_status <- "Canonical SJ"
stat_df$splice_junction_position <- "chr17:7674291-7674858"
...
### Canonical SJ Exon upstream (UE): chr17:7674972-7675052 {.tabset}
...
MUT_df$Prediction <- "Canonical Loss"
MUT_df$splice_junction_status <- "CanonicalSJ"
MUT_df$splice_junction_position <- "chr17:7674972-7675052"
...
```{r}
shapiro.test(SJCounts$Normalized_CanonUE[SJCounts$GROUP== "MUT"])
```

Mann-Whitney:
```{r}
wt <- wilcox.test(x=SJCounts$Normalized_CanonUE[SJCounts$GROUP== "MUT"], 
                  y=SJCounts$Normalized_CanonUE[SJCounts$GROUP== "WT"],
                  alternative = "two.sided", 
                  paired = FALSE, 
                  conf.int = 0.95)
...
stat_df$Prediction <- "Canonical Loss"
stat_df$splice_junction_status <- "Canonical SJ"
stat_df$splice_junction_position <- "chr17:7674972-7675052"
...
Download the normalized values for the assessed splice junctions of all the AML samples:
```{r echo=FALSE}
normalization_df <- GeneSJ[,c("sample_id","case_id", "GROUP","Normalized_CanonUE","Normalized_CanonDE", "Normalized_ES", "chr17_7674972_7675052", "chr17_7674291_7674858",  "chr17_7674291_7675052", "chr17_7674972_7675052","chr17_7674972_7675052", "rowSum_SJtotal","file_id.BAM","file_name.BAM","file_id.STAR.SJCounts","file_name.STAR.SJCounts" )]

colnames(normalization_df)[grep("chr17_7674972_7675052", names(normalization_df))] <- "chr17_7674972_7675052_CanonUE"
colnames(normalization_df)[grep("chr17_7674291_7674858", names(normalization_df))] <- "chr17_7674291_7674858_CanonDE"
colnames(normalization_df)[grep("chr17_7674291_7675052", names(normalization_df))] <- "chr17_7674291_7675052_ES"
...
* **Acceptor Gain**: chr2:25235821-25236935, found in the mutated samples.
* **Acceptor Loss**: chr2:25235826-25236935, acceptor splice site chr2:25238256.
...
### Canonical SJ
Exon upstream (UE): chr2:25235826-25236935, acceptor splice site chr2:25238256
...
ggplot(GeneSJ, aes(sample_id,Normalized_CanonUE,color=GROUP)) +
  ...
  labs(color='GROUP', 
       ...
       subtitle="Potential Acceptor Loss Effect on Canonical SJ",
       y = "Normalized Expression")
```
...
ggplot(GeneSJ, aes(sample_id,Normalized_AG,color=GROUP)) +
  ...
  labs(color='GROUP', 
       ...
       subtitle="Potential Acceptor Gain Effect",
       y = "Normalized Expression") 
```
...
* **Acceptor Gain**: chr12:49031313-49032512, found in the mutated samples.
* **Acceptor Loss**: chr12:49033965-49034066; acceptor splice site chr12:49033965.
...
### Canonical SJ
Exon upstream (UE): chr12:49033965-49034066; acceptor splice site chr12:49033965
...
* **Acceptor Gain**: predicted at 38bp from the variant, chr4:105259811, not found in the splice junction collection.
...
writexl::write_xlsx(summary_res, paste0(summary_dir_out, "/BeatAML.report-v3.xlsx"))
```
